const Footer = () => {
    return(
        // <footer className="bg-black text-white py-10 px-6 md:px-12 lg:px-24">
        //     <div className="flex flex-col sm:flex-row sm:justify-between gap-10 sm:gap-4 mb-8">
        //         <div className="sm:w-1/2">
        //             <h2 className="text-2xl font-bold mb-2">CHANDAN GAUTAM</h2>
        //             <p className="text-sm leading-relaxed">A Frontend focused Web Developer building the Frontend of Websites and Web Applications that leads to the success of the overall product</p>
        //         </div>
